...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.session) {
        // Set the cookies manually for middleware
      ...
      <div className="relative w-full max-w-md p-2">
        ...
        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/40 p-8 shadow-2xl backdrop-blur-xl">
          <div className="mb-8 flex flex-col items-center text-center">
            <img src="/logo.png" alt="Fintura Logo" className="h-16 w-16 rounded-xl border border-slate-800 bg-slate-950/80 p-1 shadow-lg" />
            ...
            <p className="mt-2 text-xs text-slate-400">
              Automated Accounting & Statement Intelligence
            </p>
          </div>
